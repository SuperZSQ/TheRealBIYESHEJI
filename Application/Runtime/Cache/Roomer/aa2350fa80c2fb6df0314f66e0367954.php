...
<div class="page-container">
    ...
    <form action="<?php echo U('login/login');?>" method="post">
        <input type="text" name="r_id" id="r_id" class="r_id" placeholder="工号">
        <input type="password" name="r_password" id="r_password" class="password" placeholder="密码">
