...
<div id="wrapper">
    <div id="container">
        ...
        <div class="login" style="margin-top:50px;">
            ...
            <div class="header">
                <div class="switch" id="switch" style="align:center"><a class="switch_btn_focus" id="switch_qlogin" href="javascript:void(0);" tabindex="7">找回密码</a>
                ...
                <div class="web_login" id="web_login">
                    ...
                    <div class="login-box">
                        ...
                        <div class="login_form">
                            <form action="<?php echo U('login/find_pwds');?>"  method="post"><input type="hidden" name="did" value="0"/>
                                <input type="hidden" name="to" value="log"/>
                                <div class="uinArea" id="uinArea">
                                    <label class="input-tips" for="u">邮箱：</label>
                                    <div class="inputOuter" id="uArea">

                                        <input type="text" id="u" name="user_email" class="inputstyle"/>
                                    </div>
                                </div>
                                ...
                                <a href="<?php echo U('login/index');?>" >返回登录</a>
                            </form>
                        </div>
